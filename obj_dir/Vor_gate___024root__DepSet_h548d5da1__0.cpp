...
VlCoroutine Vor_gate___024root___eval_initial__TOP__Vtiming__0(Vor_gate___024root* vlSelf);
...
void Vor_gate___024root___eval_initial(Vor_gate___024root* vlSelf) {
    ...
    // Body
    Vor_gate___024root___eval_initial__TOP__Vtiming__0(vlSelf);
}
...
void Vor_gate___024root___timing_resume(Vor_gate___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vor_gate__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vor_gate___024root___timing_resume\n"); );
    // Body
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
...
bool Vor_gate___024root___eval_phase__act(Vor_gate___024root* vlSelf) {
    ...
    if (__VactExecute) {
        ...
        Vor_gate___024root___timing_resume(vlSelf);
...
#endif
            VL_FATAL_MT("or_gate_tb.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("or_gate_tb.v", 1, "", "Active region did not converge.");
            }
